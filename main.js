...
function callApi() {
    ...
    xmlHttp.addEventListener("load", function () {
        console.log(new Date().toLocaleDateString(), new Date().toLocaleTimeString('en-US', { hour12: false }), xmlHttp.status, xmlHttp.statusText);
...
function notify(date, district, quota, quota_amount) {
    ...
    xmlHttp.addEventListener("load", function () {
        console.log(new Date().toLocaleDateString(), new Date().toLocaleTimeString('en-US', { hour12: false }), xmlHttp.status, xmlHttp.response);
    }, false);
